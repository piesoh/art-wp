...
// 			query_posts('posts_per_page=16&paged=' . $paged);
			if ( have_posts() ) : ?>
...
//   									the_post_thumbnail('miniature-article');
// 									get_the_image_by_post_thumbnail( array( 'size' => 'post-thumbnail', 'image_class' => 'featured', 'width' => 220, 'height' => 150, 'default_image' => get_template_directory_uri() . '/images/archive_image_placeholder.png' ) );
// 								} 					
	

// 								else if ( current_theme_supports( 'get-the-image' ) ) {
...
// 									get_the_image( array( 'size' => 'archive-thumbnail', 'image_class' => 'featured', 'width' => 220, 'height' => 150, 'default_image' => get_template_directory_uri() . '/images/archive_image_placeholder.png' ) );
									get_the_image( array( 'size' => 'archive-thumbnail', 'image_class' => 'featured', 'default_image' => get_template_directory_uri() . '/images/archive_image_placeholder.png' ) );
